...
class Loja {
    ...
    public function marcarFotoLoja2($id){
        ...
        if($item->posicao_1 == $id){
            $status = 1;
            $loja = 1;
        }
        
        if($item->posicao_2 == $id){
            $status = 1;
            $loja = 1;
        }
        
        if($item->posicao_3 == $id){
            $status = 1;
            $loja = 1;
        }
        
        if($item->posicao_4 == $id){
            $status = 1;
            $loja = 1;
        }
        
        if($item->posicao_5 == $id){
            $status = 1;
            $loja = 1;
        }
        
        if($item->posicao_6 == $id){
            $status = 1;
            $loja = 1;
        }
        
        if($item->posicao_7 == $id){
            $status = 1;
            $loja = 1;
        }
        
        if($item->posicao_8 == $id){
            $status = 1;
            $loja = 1;
        }
        ...
        if($loja == 1){
            ...
            if($item->posicao_9 == $id){
                $status = 1;
            }

            if($item->posicao_10 == $id){
                $status = 1;
            }

            if($item->posicao_11 == $id){
                $status = 1;
            }

            if($item->posicao_12 == $id){
                $status = 1;
            }

            if($item->posicao_13 == $id){
                $status = 1;
            }

            if($item->posicao_14 == $id){
                $status = 1;
            }

            if($item->posicao_15 == $id){
                $status = 1;
            }

            if($item->posicao_16 == $id){
                $status = 1;
            }
        }
