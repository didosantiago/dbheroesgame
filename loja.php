<?php 
    ...
    $anuncio_1 = $core->getDados('adm_loja_itens', "WHERE id =".$listaAnuncios->posicao_1);
    $anuncio_2 = $core->getDados('adm_loja_itens', "WHERE id =".$listaAnuncios->posicao_2);
    $anuncio_3 = $core->getDados('adm_loja_itens', "WHERE id =".$listaAnuncios->posicao_3);
    $anuncio_4 = $core->getDados('adm_loja_itens', "WHERE id =".$listaAnuncios->posicao_4);
    $anuncio_5 = $core->getDados('adm_loja_itens', "WHERE id =".$listaAnuncios->posicao_5);
    $anuncio_6 = $core->getDados('adm_loja_itens', "WHERE id =".$listaAnuncios->posicao_6);
    $anuncio_7 = $core->getDados('adm_loja_itens', "WHERE id =".$listaAnuncios->posicao_7);
    $anuncio_8 = $core->getDados('adm_loja_itens', "WHERE id =".$listaAnuncios->posicao_8);
            ...
            <div class="destaques">
                ...
                <div id="destaque_one" class="item-destaque <?php echo $loja->getClassRarirade($anuncio_1->foto); ?>">
                    <a href="<?php echo BASE; ?>loja/produto/<?php echo $anuncio_1->id ?>">
                        ...
                        <div class="infos">
                            <h5><?php echo $loja->getNomeFoto($anuncio_1->idBoneco, $anuncio_1->modulo, $anuncio_1->nome) ?></h5>
                            <span class="tipo"><?php echo $loja->getTipoProduto($anuncio_1->modulo); ?></span>
                ...
                <div id="destaque_two" class="item-destaque <?php echo $loja->getClassRarirade($anuncio_2->foto); ?>">
                    ...
                    <a href="<?php echo BASE; ?>loja/produto/<?php echo $anuncio_2->id ?>">
                        ...
                        <div class="infos">
                            <h5><?php echo $loja->getNomeFoto($anuncio_2->idBoneco, $anuncio_2->modulo, $anuncio_2->nome) ?></h5>
